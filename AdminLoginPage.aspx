<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLoginPage.aspx.cs" Inherits="CafeteriaManagement.AdminLoginPage" %>
...
<body class="sub_page">
  ...
  <div class="hero_area">
    ...
    <asp:Label ID="Label1" runat="server" Text="Login As Admin" Font-Size="XX-Large" Font-Bold="true" ForeColor="Black"></asp:Label>
...
<asp:Button CssClass="btn-cancel" ID="Button2" runat="server" Font-Size="Large" Text="Cancel" ForeColor="White" BackColor="Red" Height="40px" Width="90px" OnClick="Button2_Click1" />
</div>
</form>
    <div></div>
    <div></div>
