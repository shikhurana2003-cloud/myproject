<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MenuPage.aspx.cs" Inherits="CafeteriaManagement.MenuPage" %>
...
<body class="sub_page">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="MenuPage.aspx">Menu <span class="sr-only">(current)</span> </a>
              </li>
              <li class="nav-item">
 ...
 <div class="col-md-4">
   <div class="card mb-4 shadow-sm">
     ...
     <div class="card-body text-center">
       <h5 class="card-title">Pav Bhaaji</h5>
