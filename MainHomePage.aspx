<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainHomePage.aspx.cs" Inherits="CafeteriaManagement.MainHomePage" %>
...
<body>
    ...
    <header class="header_section">
      <div class="container">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href="MainHomePage.aspx">
            <span>
             ANDAAZ RASOI CAFE   
            </span>
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              <li class="nav-item active">
                <a class="nav-link" href="MainHomePage.aspx">Home <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
  ...
  <a href="RegisterNow.aspx" class="order_online">REGISTER NOW</a>                          
 </div>
            <div class="user_option">
              <a href="" class="user_link">
                <i class="fa fa-user" aria-hidden="true"></i>
              </a>             
             <a href="UserLoginPage.aspx" class="order_online">USER LOGIN</a>                          
            </div>
              <div class="user_option">
  <a href="" class="user_link">
    <i class="fa fa-user" aria-hidden="true"></i>
 ...
 <a href="AdminLoginPage.aspx" class="order_online">ADMIN LOGIN</a>
</div>
          </div>
        </nav>
      </div>
...
Under the golden glow of hanging lights, the café became a place where time slowed down, and every shared cup felt like a story unfolding.                    </p>
                    <div class="btn-box">
                      <a href="UserLoginPage.aspx" class="btn1" id="btnOrder">
                        Book Table Now
                      </a>
                    </div>
                  </div>
...
Under the golden glow of hanging lights, the café became a place where time slowed down, and every shared cup felt like a story unfolding.                    </p>
                    <div class="btn-box">
                      <a href="UserLoginPage.aspx" class="btn1">
                        Book Table Now
                      </a>
                    </div>
                  </div>
...
Haryana                </p>
              ...
              <div class="img-box">
                <img src="images/me2.jpeg" alt="" class="box-img">
              </div>
            </div>
          </div>
          <div class="item">
...
Ambala                </p>
              ...
              <div class="img-box">
                <img src="images/ptlo1.jpeg" alt="" class="box-img">
              </div>
            </div>
          </div>
        </div>
